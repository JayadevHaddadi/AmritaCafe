...
val DEFAULT_BREAKFAST_MENU: List<MenuItemUS> = listOf(
    ...
    MenuItemUS("Pesto", "PSTO", 30f, "Side"),
    MenuItemUS("Raw Egg", "RAW EGG", 15f, "Side"),
    MenuItemUS("Ketchup", "KETUP", 5f, "Side"),
    MenuItemUS("Olive", "OLV", 30f, "Side"),
    MenuItemUS("Onion", "ON", 5f, "Side"),
    MenuItemUS("Fresh Tomato", "FRT", 10f, "Side"),
...
val DEFAULT_LUNCH_DINNER_MENU: List<MenuItemUS> = listOf(
    ...
    MenuItemUS("Patty", "PATTY", 30f, BURGER),
    MenuItemUS("Deluxe Burger", "DLXB", 80f, BURGER),
    MenuItemUS("Pesto Burger", "PSTOB", 70f, BURGER),
    ...
    MenuItemUS("Pesto Pasta", "PSTO PAST", 65f, "Pasta"),
    ...
    MenuItemUS("Quinoa Salad", "QNA SAL", 90f, "Salad"),
